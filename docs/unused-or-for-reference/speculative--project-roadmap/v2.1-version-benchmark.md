# Potentially upcoming v2.1 -- production simulation, locally

## Goal

- Create a local dev environment-- simple, easy to run.

And create a local production simulation environment.
This will be a bit more complicated.
To generate its dependencies (node_modules) we'd run:
