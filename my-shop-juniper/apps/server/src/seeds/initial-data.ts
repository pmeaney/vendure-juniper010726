...
import { InitialData } from "@vendure/core/dist/data-import";
  ...
  collections: [
    ...
    },
    {
      ...
      filters: [
        {
          code: "facet-value-filter",
          args: { facetValueNames: ["Guitars"], containsAny: false },
        },
      ],
      assetPaths: ["guitar-general-classical.jpg"],
    },
    {
      ...
      filters: [
        {
          code: "facet-value-filter",
          args: { facetValueNames: ["Classical Guitars"], containsAny: false },
        },
      ],
      assetPaths: ["guitar-general-classical.jpg"],
      parentName: "Guitars",
    ...
    {
      name: "Flamenco Guitars",
      filters: [
        {
          code: "facet-value-filter",
          args: { facetValueNames: ["Flamenco Guitars"], containsAny: false },
        },
      ],
